...
class Page extends React.Component {
    ...
    render() {
        ...
        return (
            <div ref={el => this.target = el} style={Object.assign({}, background, {position: 'relative', width: '100%', height: '100vh', backgroundColor: '#eee', display: 'flex', boxSizing: 'border-box'})}>
